...
<html>
	...
	<body class="fade-in one" style="background-color:#00000">
		...
		<?php
				...
				or header( "Location: http://masterji.xyz/404.html" );
		...
		echo '<div class="container-fluid text-center ">
			...
			<h2 style="color:#0d88bf;font-size:35px;font-family:Chelsea; "><strong>Choose Your Semester</strong></h2>
			<br><br>
            ...
            <h1 style="color:#0d88bf;font-size:35px;font-family:Chelsea;"><strong>'.$_GET['br'].' Branch</strong></h1><br><br>
			<h2 style="color:#0d88bf;font-size:35px;font-family:Chelsea; "><strong>No notes have been provided for this branch.<br> Please request your faculty to upload. Thanks! </strong></h2>
			<br><br>';
			}
			?>
		<?php
		...
		<script src="http://masterji.xyz/js/polyfills.js"></script>
		<script src="http://masterji.xyz/js/demo1.js"></script>
