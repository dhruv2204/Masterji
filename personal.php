...
<?php if(adminloggedin()){define('access',1);
    include 'head.php';
	define('access',1);
	include'navbar.php'; 
	echo '
				...
				<div id="branch" class="container-fluid text-center ">
					...
					<div class="row  img-responsive ">
						...
						<div class="col-sm-6 col-md-4 col-xs-12  " >
							<span  ><a href="addsem.php?br=CS"  ><img src="images/cs.png"  ></a></span>
							<h4 >Computer Science</h4>
						</div>
						
						<div class="col-sm-6 col-md-4 col-xs-12  ">
							<span ><a href="addsem.php?br=EC"><img src="images/ec.png" ></a></span>
							<h4>Electronics</h4>
						</div>
						
						<div class="col-sm-6 col-md-4 col-xs-12  ">
							<span ><a href="addsem.php?br=EE"><img src="images/ee.png" ></a></span>
							<h4>Electrical</h4> 
						</div>
						...
						<div class="col-sm-6 col-md-4 col-xs-12  ">
							<span ><a href="addsem.php?br=IT"><img src="images/it.png" ></a></span>
							<h4>Information Technology</h4>
						</div>
						
						<div class="col-sm-6 col-md-4 col-xs-12  ">
							<span ><a href="addsem.php?br=ME"><img src="images/me.png" ></a></span>
							<h4>Mechanical</h4>     
						</div>
						
						<div class="col-sm-6 col-md-4 col-xs-12  ">
							<span ><a href="addsem.php?br=CE"><img src="images/ce.png" ></a></span>
							<h4>Civil</h4>
							<br><br>
						</div>
					</div>
...
<h3 align="center">You are logged in. <a href="logout.php">Log out</a></h3>';
	}
